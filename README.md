...
​               Desenvolvolvimento de um pequeno sistema para o gerenciamento de pessoas de uma empresa                                   através de uma API REST, criada com o Spring Boot.
...
Links para auxiliar no desenvolvimento:
